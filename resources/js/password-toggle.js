...
function enhance(input) {
    ...
    button.type = 'button';
    button.className = 'absolute inset-y-0 right-0 flex items-center pr-4 text-muted-foreground transition hover:text-foreground focus:outline-none focus-visible:text-primary';
